...
public class BookingController {
	...
	public ResponseEntity<List<Booking>> getAllBookingsByUser(@Parameter(description = "User id") @PathVariable Long id){

			return bookingService.getAllBookingsByUser(id);
	...
	public ResponseEntity<List<Booking>> getAllBookingsByRestaurant(@Parameter(description = "Restaurant id") @PathVariable Long id){
...
//---------------------------------------------------------------------------//
	...
	public ResponseEntity<List<Booking>> getAllBookingsByOpenTime(@Parameter(description = "Opening time filter") @PathVariable LocalDateTime openTime){

			return bookingService.getAllBookingsByOpenTime(openTime);
	...
	public ResponseEntity<List<Booking>> getAllBookingsByCloseTime(@Parameter(description = "Closing time filter") @PathVariable LocalDateTime closeTime){

			return bookingService.getAllBookingsByCloseTime(closeTime);
	...
	public ResponseEntity<List<Booking>> getAllBookingsByStatus(@Parameter(description = "Status filter") @PathVariable BookingStatus status){
	...
	public ResponseEntity<List<Booking>> getAllBookingsByNoOfPeople(@Parameter(description = "Number of people filter") @PathVariable Integer people){

			return bookingService.getAllBookingsByNoOfPeople(people);
...
//	}
    ...
    public ResponseEntity<List<String>> updateBooking(@Parameter(description = "Booking id") @PathVariable Long id, @Parameter(description = "New number of people") @RequestBody BookingUpdation request){
